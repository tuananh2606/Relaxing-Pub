...
import { SelectProvidersDialog, PreviewModal } from '~/components/dialog';
...
const HeroVideo = ({ items }: IHeroVideo) => {
  ...
  const backdropPath = TMDB?.backdropUrl((details as IMovieDetail | ITvShowDetail)?.backdrop_path!, 'w1280');
  ...
  return (
    <div className="relative">
      <HeroPlayer isMuted={isMuted} playing={isPlaying} url={trailerVideo?.key} backdropPath={backdropPath} />
