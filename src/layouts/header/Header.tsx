...
const Header = () => {
  return (
    <header>
      <div
        className={` ${styles.mainHeader} fixed left-0 top-0 z-10 flex h-16 max-h-[70px] w-full items-center bg-header-bg px-[4%] lg:h-16 lg:bg-transparent`}
      >
        ...
        <a>Logo</a>
        <div className="fixed left-0 top-0 mt-14 h-full w-[250px] bg-black lg:relative lg:mt-0 lg:flex lg:w-full lg:items-center lg:bg-transparent">
          <div className="primary-navigation flex items-center">
