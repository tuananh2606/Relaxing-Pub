  ...
  return (
    <main>
      <div className="relative h-auto max-h-screen overflow-hidden">
        ...
        <div className="absolute bottom-[10%] left-[5%] w-[36%]">
          <h1 className="text-2xl">Spider-Man: Across the Spider-Verse</h1>
          <p className="mt-[1.5vw] text-lg">
          ...
          <div className="actions-btn mt-[1.5vw] flex items-center">
            <button className="mr-3 flex items-center justify-center rounded-[4px] bg-white px-7 py-2 hover:bg-[rgba(255,255,255,0.75)]">
              <span>
        ...
        <div className="absolute bottom-[10%] right-[5%]">
          <button className="rounded-full border p-2" onClick={playPauseHandler}>
            {isMuted ? (
